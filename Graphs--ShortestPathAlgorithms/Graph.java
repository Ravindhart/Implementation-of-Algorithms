...
class Graph implements Iterable<Vertex> {
    ...
    public List<Edge> edges; //list of edges for preprocessing
    public int spWeight; //represents sum of shortest path weights.
    public AlgoType algo; //represents which algorithm is appropriate for this graph
    public int totalPaths; //represents sum of all shortest paths from source to every other vertex
